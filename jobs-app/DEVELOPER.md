...
| AI CV tailoring | Implemented in PR #10 | Local matching, protected AI drafting, usage limits, complete source-CV preservation, and form-validation safeguards. Merge PR #10 and add the server secret before production acceptance testing. |
...
- Merge PR #10 after review checks pass.
